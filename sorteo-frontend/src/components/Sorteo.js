...
function Sorteo() {
  ...
  const agregarPremioAlSorteo = () => {
    ...
    setItems([
      ...items,
      { id: premio.id, nombre_item: premio.nombre, cantidad: selectedPremioCantidad },
    ]);
  ...
  const eliminarPremioDelSorteo = (id) => {
    ...
    // Reinserta el premio a la lista de disponibles (ajusta la lógica de stock según sea necesario)
    setAvailablePremios([
      ...availablePremios,
      { id: premio.id, nombre: premio.nombre_item, stock: premio.cantidad },
    ]);
